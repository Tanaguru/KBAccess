...
<!DOCTYPE html>
<html lang="fr">
    <c:set var="title" value="Ajout de testcase 3/3 - Récapitulatif " />
    ...
    <body>
        ...
        <div class="row well">
            ...
            <p><a href="<c:url value='/testcase/details/${testcase.id}/${testcaseUrl}'/>">Visualiser le testcase</a> ou <a href="<c:url value='/'/>">revenir à l'accueil</a>.</p>
        </div>
